...
k8s_resource('backend-javascript-patterns-v1', port_forwards=8000, resource_deps=['deploy', 'conftest'])
...
docker_build('styled-javascript-patterns', '.', build_args={'IMAGE_SOURCE': 'node', 'IMAGE_TAG': '12-buster'},
